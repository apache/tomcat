...
public class JavaCompiler extends Compiler {
    ...
    protected void generateClass(Map<String, SmapStratum> smaps) throws JasperException, IOException {
        ...
        try (StandardJavaFileManager fileManager = compiler.getStandardFileManager(diagnostics, null,
            ...
            Boolean result = compiler.getTask(null, fileManager, diagnostics, compilerOptions, null, compilationUnits)
                    .call();
                    ...
                    if (diagnostic.getKind() == Diagnostic.Kind.ERROR) {
                        try {
                            problemList.add(ErrorDispatcher.createJavacError(diagnostic.getSource().getName(),
                                    pageNodes, new StringBuilder(diagnostic.getMessage(Locale.getDefault())),
