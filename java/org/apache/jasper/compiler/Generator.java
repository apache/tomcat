...
class Generator {
    ...
    private final DateTimeFormatter DTFZ = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").withZone(ZoneOffset.UTC);
    ...
    private void generateCommentHeader() {
        ...
        if (ctxt.getOptions().getGeneratedJavaAddTimestamp()) {
            ZonedDateTime zdtNow = ZonedDateTime.ofInstant(Instant.now(), ZoneId.systemDefault());
            out.println(" * Generated at: " + DTFZ.format(zdtNow) +
                        " UTC");
        }
