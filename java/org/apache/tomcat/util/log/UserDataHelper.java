 ...
 * <ul>
 * <li>NONE: Log nothing.</li>
 * <li>DEBUG_ALL: Log all problems at DEBUG log level.</li>
 * <li>INFO_THEN_DEBUG: Log first problem at INFO log level and any further issues in the following configurable
 * suppression time (the <code>org.apache.juli.logging.UserDataHelper.SUPPRESSION_TIME</code> system property, in
