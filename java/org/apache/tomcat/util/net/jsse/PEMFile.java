...
public class PEMFile {
    ...
    public PEMFile(String filename, String password, String passwordFilename, String keyAlgorithm)
        ...
        this(filename, ConfigFileLoader.getInputStream(filename), password, passwordFilename,
                passwordFilename != null ? ConfigFileLoader.getInputStream(passwordFilename) : null, keyAlgorithm);
    }
