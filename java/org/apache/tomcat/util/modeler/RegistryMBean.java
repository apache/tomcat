 ...
 * model mbeans and simplify their use. Starting with version 1.1, this is no longer a singleton. In a container
 * environment we can expect different applications to use different registries.
 */
