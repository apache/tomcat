...
public interface ContextBind {
    ...
    /**
     * Restore the current thread context class loader to the original class loader in use before
     * {@link #bind(ClassLoader)} was called. If no original class loader is passed to this method then no change will
     * be made. If the class loader is changed and a {@link org.apache.catalina.ThreadBindingListener} is configured
     * then {@link org.apache.catalina.ThreadBindingListener#unbind()} will be called before the change is made.
     *
