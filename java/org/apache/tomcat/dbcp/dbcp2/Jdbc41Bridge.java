...
public class Jdbc41Bridge {
    ...
    /**
     * Delegates to {@link DatabaseMetaData#generatedKeyAlwaysReturned()} without throwing an
    ...
    /**
     * Delegates to {@link DatabaseMetaData#getPseudoColumns(String, String, String, String)} without throwing an
     * {@link AbstractMethodError}.
     * <p>
