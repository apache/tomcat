...
public class Utils {
    ...
    static void insertEditInstructions(Writer w) throws IOException {
        ...
        w.write("# Do not edit this file directly. Translations are managed via poeditor.");
        w.write(System.lineSeparator());
        w.write("# Join to edit translations: https://poeditor.com/join/project/NUTIjDWzrl");
        w.write(System.lineSeparator());
        w.write("# View the translations    : https://poeditor.com/projects/view?id=221603");
        w.write(System.lineSeparator());
    }
}
