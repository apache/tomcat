    ...
    protected void bind(Name name, Object obj, boolean rebind)
        ...
        if (name.size() > 1) {
            ...
            if ((!rebind) && (entry != null)) {
                ...
                switch (toBind) {
                    case Context _ -> entry = new NamingEntry(name.get(0), toBind,
                        NamingEntry.CONTEXT);
                    case LinkRef _ -> entry = new NamingEntry(name.get(0), toBind,
                        NamingEntry.LINK_REF);
                    case Reference _ -> entry = new NamingEntry(name.get(0), toBind,
