...
/**
 * Adaptor to allow {@link FileItem} objects generated by the repackaged Apache Commons FileUpload package
 * ({@code org.apache.tomcat.util.http.fileupload}) to be used by the Servlet 3.0 upload API that expects
 * {@link Part}s.
 */
