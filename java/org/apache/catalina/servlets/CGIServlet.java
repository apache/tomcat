...
public final class CGIServlet extends HttpServlet {
    ...
    static {
        ...
        if (JrePlatform.IS_WINDOWS) {
            DEFAULT_CMD_LINE_ARGUMENTS_DECODED_PATTERN = Pattern.compile("[\\w\\Q-.\\/:\\E]+"); //here \\w is equals [a-zA-Z0-9_] for performance reasons
        } else {
            // No restrictions
    ...
    private Pattern cmdLineArgumentsEncodedPattern =
            Pattern.compile("[\\w\\Q%;/?:@&,$-.!~*'()\\E]+"); //here \\w is equals [a-zA-Z0-9_] for performance reasons
