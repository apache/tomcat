...
public class RangedPutRequestBoundsFilter extends FilterBase {
     ...
     */
    private static final long DEFAULT_MAX_BOUND_UP = 1L << 32;
    private static final String PARAMETER_MAX_SIZE = "maxSize";

    /**
     * Maximum size of a ranged PUT target resource. 4GB by default.
     */
    private long maxSize = DEFAULT_MAX_BOUND_UP;
    ...
    private final transient Log log = LogFactory.getLog(RangedPutRequestBoundsFilter.class);
    ...
    private boolean checkContentRangeBounds(HttpServletRequest req, String contentRangeHeader) {
        try {
            ...
            if (contentRange != null && getMaxSize() >= 0 &&
