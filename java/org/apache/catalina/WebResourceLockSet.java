...
public interface WebResourceLockSet {
     ...
     * Multiple calls to this method with the same path will return locks that share the same underlying read/write
     * lock provided that at least one instance of the lock remains in use between the calls.
     *
