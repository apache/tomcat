...
public interface Host extends Container {
    ...
    /**
     * Get the legacy (Java EE) application root for this Host. This can be an absolute pathname, a relative
     * pathname, or a URL.
     *
     * @return the legacy application root
     */
    String getLegacyAppBase();


    /**
     * Get an absolute {@link File} for the legacy (Java EE) appBase of this Host. The file will be canonical if
     * possible. There is no guarantee that the appBase exists.
     *
     * @return the legacy application base file
     */
    ...
    /**
     * Get the value of the auto deploy flag. If true, it indicates that this host's child webapps should be
     * discovered and automatically deployed dynamically.
     *
     * @return the auto deploy flag
     */
