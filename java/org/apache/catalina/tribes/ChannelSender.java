 ...
 * at the bottom layer, the IO layer (for layers see the {@link Channel} interface).
 * The channel sender must support "silent" members, i.e., be able to send a message to a member
