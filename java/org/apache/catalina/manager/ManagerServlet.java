...
public class ManagerServlet extends HttpServlet implements ContainerServlet {
     ...
     */
    protected void deploy(PrintWriter writer, ContextName cn, String tag, boolean update, HttpServletRequest request,
    ...
    /**
     * Delete the specified directory, including all of its contents and subdirectories recursively. The code assumes
