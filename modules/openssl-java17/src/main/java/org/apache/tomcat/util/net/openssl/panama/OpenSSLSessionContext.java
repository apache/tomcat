...
public class OpenSSLSessionContext implements SSLSessionContext {
    ...
    public void setTicketKeys(byte[] keys) {
        ...
        try (var scope = ResourceScope.newConfinedScope()) {
            var array = SegmentAllocator.ofScope(scope).allocateArray(CLinker.C_CHAR, keys);
    ...
    public boolean setSessionIdContext(byte[] sidCtx) {
        try (var scope = ResourceScope.newConfinedScope()) {
            var array = SegmentAllocator.ofScope(scope).allocateArray(CLinker.C_CHAR, sidCtx);
