...
public class TestHttp2Limits extends Http2TestBase {
    ...
    private void doTestHeaderLimits(int headerCount, int headerSize, int maxHeaderPayloadSize,
        ...
        doTestHeaderLimits(headerCount, headerSize, maxHeaderPayloadSize,
                Constants.DEFAULT_MAX_HEADER_COUNT, Constants.DEFAULT_MAX_HEADER_SIZE, -1, -1, delayms,
                failMode);
    }
    ...
    private void doTestHeaderLimits(int headerCount, int headerSize, int maxHeaderPayloadSize,
        ...
        if (maxRequestHeaderSize != -1){
            ((AbstractHttp11Protocol<?>) http2Protocol.getHttp11Protocol()).setMaxHttpRequestHeaderSize(maxRequestHeaderSize);
        }

        if (maxResponseHeaderSize != -1){
            ((AbstractHttp11Protocol<?>) http2Protocol.getHttp11Protocol()).setMaxHttpResponseHeaderSize(maxResponseHeaderSize);
        }
