...
public class TestRewriteValve extends TomcatBaseTest {
    ...
    public void testRewriteMap12() throws Exception {
        doTestRewrite("RewriteMap mapb txt:classpath:org/apache/catalina/valves/rewrite/TesterRewriteMapB\n" +
    ...
    public void testRewriteMap19() throws Exception {
        doTestRewrite("RewriteMap mapb txt:classpath:org/apache/catalina/valves/rewrite/TesterRewriteMapB first\n" +
            "RewriteRule /b/(.*).html$ /c/${mapb:$1}", "/b/aa.html", "/c/aaaa");
    }

    @Test(expected = IllegalStateException.class)
    public void testRewriteMap20() throws Exception {
        doTestRewrite("RewriteMap mapb txt:classpath:org/apache/catalina/valves/rewrite/TesterRewriteMapB first second\n" +
            "RewriteRule /b/(.*).html$ /c/${mapb:$1}", "/b/aa.html", "/c/aaaa");
    }

    @Test
    public void testRewriteMap21() throws Exception {
        doTestRewrite("RewriteMap mapb rnd:classpath:org/apache/catalina/valves/rewrite/TesterRewriteMapC\n" +
            "RewriteRule /b/(.*).html$ /c/${mapb:$1}", "/b/a.html", "/c/aa");
    }
    ...
    public void testRewriteMap24() throws Exception {
        doTestRewrite("RewriteMap mapb rnd:classpath:org/apache/catalina/valves/rewrite/TesterRewriteMapC first\n" +
            "RewriteRule /b/(.*).html$ /c/${mapb:$1}", "/b/aa.html", "/c/aaaa");
    }

    @Test(expected = IllegalStateException.class)
    public void testRewriteMap25() throws Exception {
        doTestRewrite("RewriteMap mapb rnd:classpath:org/apache/catalina/valves/rewrite/TesterRewriteMapC first second\n" +
            "RewriteRule /b/(.*).html$ /c/${mapb:$1}", "/b/aa.html", "/c/aaaa");
    }
