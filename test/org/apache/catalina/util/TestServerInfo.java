...
public class TestServerInfo {
    ...
    public void testParseVersionFromFilename() throws Exception {
        ...
        Object[][] testCases = {
            ...
            {"spring-core-5.3.20.RELEASE.jar", "5.3.20.RELEASE", "RELEASE suffix"},
            {"jackson-databind-2.15.0.jar", "2.15.0", "standard Maven version"},
    ...
    public void testGetJarVersionFallbackToFilename() throws Exception {
        ...
        }, jar -> Assert.assertEquals("Should fallback to filename parsing", "3.2.1",
                invokeGetJarVersion(jar)));
    }
    ...
    public void testGetJarVersionPrefersManifest() throws Exception {
        ...
        }, jar -> Assert.assertEquals("Should prefer manifest version over filename", "2.0.0",
                invokeGetJarVersion(jar)));
    }
    ...
    /**
     * Helper method to invoke the private parseVersionFromFilename() method via reflection.
     */
    private String invokeParseVersionFromFilename(String filename) throws Exception {
        Method method = ServerInfo.class.getDeclaredMethod("parseVersionFromFilename", String.class);
        method.setAccessible(true);
