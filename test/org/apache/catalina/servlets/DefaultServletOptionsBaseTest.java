...
public abstract class DefaultServletOptionsBaseTest extends ServletOptionsBaseTest {
        ...
        for (Boolean listingsValue : booleans) {
            for (Boolean readOnlyValue : booleans) {
                for (Boolean traceValue : booleans) {
                    for (String url : urls) {
                        result.add(new Object[] { listingsValue, readOnlyValue, traceValue, url, method });
                    }
                }
            }
