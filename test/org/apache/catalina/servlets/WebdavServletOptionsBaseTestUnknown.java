 ...
 */
public abstract class WebdavServletOptionsBaseTestUnknown extends ServletOptionsBaseTest {
        ...
        for (Boolean listingsValue : booleans) {
            for (Boolean readOnlyValue : booleans) {
                for (Boolean traceValue : booleans) {
                    result.add(new Object[] { listingsValue, readOnlyValue, traceValue, UNKNOWN_NAME, method });
                }
            }
