...
package org.apache.securitymanager;
...
/**
 * Parameterized regression test for
 * <a href="https://bz.apache.org/bugzilla/show_bug.cgi?id=64735">Bug 64735</a> which confirms that
 * {@link ApplicationContextFacade} behaves correctly when the Java 2 {@link SecurityManager} has
 * been enabled.
 *
 * @author Kyle Stiemann
 */
@RunWith(Parameterized.class)
public final class TestBug64735 extends SecurityManagerTestBase {
    private final Method methodToTest;

    public TestBug64735(final Method method) {
        this.methodToTest = method;
    }

    /**
     * @return {@link Collection} of non-static, non-object, public {@link Method}s in
     * {@link ApplicationContextFacade} to be run with the the Java 2 {@link SecurityManager} been
     * enabled.
     */
    ...
    @Test
    public void test_ApplicationContextFacade_calls_do_not_throw_when_SecurityManager_is_enabled()
