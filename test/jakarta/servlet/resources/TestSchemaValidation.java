...
public class TestSchemaValidation {
    ...
    public void testWebapp() throws Exception {
        ...
        Assert.assertEquals("6.2", desc.getVersion());
    ...
    public void testWebapp_6_0() throws Exception {
        ...
        digester.setErrorHandler(handler);
        digester.push(new WebXml());
        WebXml desc = (WebXml) digester.parse(new File("test/webapp-6.0/WEB-INF/web.xml"));
    ...
    public void testWebapp_6_1() throws Exception {
        ...
        digester.setErrorHandler(handler);
        digester.push(new WebXml());
        WebXml desc = (WebXml) digester.parse(new File("test/webapp-6.1/WEB-INF/web.xml"));
    ...
    public void testWebapp_6_2() throws Exception {
        ...
        digester.setErrorHandler(handler);
        digester.push(new WebXml());
        WebXml desc = (WebXml) digester.parse(new File("test/webapp-6.2/WEB-INF/web.xml"));
        Assert.assertEquals("6.2", desc.getVersion());
        Assert.assertEquals(0, handler.getErrors().size());
        Assert.assertEquals(0, handler.getWarnings().size());
    }
