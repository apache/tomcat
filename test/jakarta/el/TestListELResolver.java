...
public class TestListELResolver {
    ...
    public void testGetValue03() {
        ...
        list.add("key");
        Object result = resolver.getValue(context, list, 0);
    ...
    public void testGetValue05() {
        ...
        List<String> list = new ArrayList<>();
        list.add("key");
        Object result = resolver.getValue(context, list, 1);

        Assert.assertNull(result);
        Assert.assertTrue(context.isPropertyResolved());

        result = resolver.getValue(context, list, -1);
    ...
    public void testGetType03() {
        ...
        List<String> list = new ArrayList<>();
        list.add("key");
        Class<?> result = resolver.getType(context, list, 0);
    ...
    public void testSetValue04() {
        ...
        List<String> list = new ArrayList<>();
        list.add("value");
        resolver.setValue(context, list, 0, "value");

        Assert.assertEquals("value",
                resolver.getValue(context, list, 0));
        Assert.assertTrue(context.isPropertyResolved());
    }
    ...
    public void testSetValue07() {
        ...
        List<String> list = new ArrayList<>();
        list.add("key");
        resolver.setValue(context, list, 1, "value");
    }
    ...
    public void testIsReadOnly03() {
        ...
        List<String> list = new ArrayList<>();
        list.add("key");
        boolean result = resolver.isReadOnly(context, list, 0);
        ...
        result = resolver.isReadOnly(context, list, 0);
